...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1555141223", "Checkpoint directory from training run")
...
def eval():
    ...
    checkpoint_file = tf.train.latest_checkpoint("./runs/1555141223/checkpoints/")
