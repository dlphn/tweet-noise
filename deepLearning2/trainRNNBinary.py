...
tf.flags.DEFINE_string("actu_file", "train_data_actualite.json", "Data source for the actuality tweets.")
tf.flags.DEFINE_string("spam_file", "train_data_spam.json", "Data source for the spam tweets.")
...
def train_rnn_binary():
    ...
    with tf.device('/cpu:0') :
        x_text, y = data_helpers.load_data_and_labels(FLAGS.actu_file, FLAGS.spam_file)
